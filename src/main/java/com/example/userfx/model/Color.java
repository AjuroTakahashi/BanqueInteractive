package com.example.userfx.model;
...
public class Color {
    ...
    private java.awt.Color ColorDecoder;
    private int rouge = 0;
    private int bleu = 0;
    private int vert = 0;
    private String hexValue = "";

    public Color(int rouge, int bleu, int vert) {
    ...
    public void setHexValue(String hexValue) {
        if (isCorrectHexValue(hexValue)) {
            ...
            java.awt.Color color = ColorDecoder.decode(hexValue);
