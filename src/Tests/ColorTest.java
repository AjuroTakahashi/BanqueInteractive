...
class ColorTest {
    ...
    public void test_constructor_RGB_with_red_value_smaller_than_0_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(-3, 141, 53));
    }

    @Test
    public void test_constructor_RGB_with_red_value_bigger_than_255_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(264, 141, 53));
    }

    @Test
    public void test_constructor_RGB_with_green_value_smaller_than_0_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(213, -31, 53));
    }

    @Test
    public void test_constructor_RGB_with_green_value_bigger_than_255_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(213, 421, 53));
    }

    @Test
    public void test_constructor_RGB_with_blue_value_smaller_than_0_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(213, 141, -132));
    }

    @Test
    public void test_constructor_RGB_with_blue_value_bigger_than_255_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(213, 141, 533));
    }
    ...
    public void test_constructor_HexValue_with_null_value_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur(null));
    }

    @Test
    public void test_constructor_HexValue_with_wrong_value_1_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur("A26F76"));
    }
    ...
    public void test_constructor_HexValue_with_wrong_value_3_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur("#G26F76"));
    }

    @Test
    public void test_constructor_HexValue_with_wrong_value_4_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur("#A26F7"));
    }

    @Test
    public void test_constructor_HexValue_with_wrong_value_5_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new Couleur("#A26F71E"));
    }
